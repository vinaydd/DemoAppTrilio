...
import com.example.app.data.NumberPreference
import com.example.app.data.NumberPreferenceDialogFragmentCompat
...
class SettingsActivity : BaseActivity() {
    ...
    class SettingsFragment : PreferenceFragmentCompat() {
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            findPreference(Preferences.VERSION_NAME).summary = VERSION_NAME
            (findPreference(Preferences.VERSION_CODE))?.let { preference ->
                preference.summary = VERSION_CODE.toString()
            }
