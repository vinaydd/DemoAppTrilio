...
import com.example.app.ui.room.VideoService.Companion.startService
import com.example.app.ui.room.VideoService.Companion.stopService
import com.example.app.util.EnvUtil
...
import com.example.app.data.api.AuthServiceException
...
class RoomManager(
    ...
    private fun handleTokenException(e: Exception, error: AuthServiceError? = null) {
        ...
        mutableViewEvents.postValue(RoomEvent.TokenError(error))
    }
