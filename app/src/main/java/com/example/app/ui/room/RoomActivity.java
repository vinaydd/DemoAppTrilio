...
import static com.example.app.data.api.AuthServiceError.EXPIRED_PASSCODE_ERROR;
...
import com.example.app.data.Preferences;
import com.example.app.util.CameraCapturerCompat;
import com.example.app.util.InputUtils;
import com.example.app.util.StatsScheduler;
...
import com.example.app.adapter.StatsListAdapter;

import com.example.app.data.api.AuthServiceError;
import com.example.app.data.api.TokenService;
import com.example.app.data.api.VideoAppService;

import com.example.app.ui.settings.SettingsActivity;
...
public class RoomActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RoomViewModel.RoomViewModelFactory factory = new RoomViewModel.RoomViewModelFactory(roomManager);
        ...
        if (roomEvent != null) {
            ...
            if (room != null) {
                ...
                if (roomEvent instanceof RoomEvent.TokenError) {
                    AuthServiceError error = ((RoomEvent.TokenError) roomEvent).getServiceError();
